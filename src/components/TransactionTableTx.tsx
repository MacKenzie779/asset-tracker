// src/components/TransactionTableTx.tsx
...
/* ---- small header cell with sorting ---- */
function SortTh({
  label,
  active,
  dir,
...
export default function TransactionsTableTx({
  items,
  accounts,
  hidden,
  onDelete,
  ...
  // IMPORTANT: keep server order as-is (no reverse)
